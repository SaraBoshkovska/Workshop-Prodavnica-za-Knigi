...
builder.Services.AddIdentity<ProdavnicaZaKnigiUser, IdentityRole>().AddEntityFrameworkStores<ProdavnicaZaKnigiContext>().AddDefaultTokenProviders().AddDefaultUI();
