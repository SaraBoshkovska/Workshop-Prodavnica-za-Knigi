...
namespace ProdavnicaZaKnigi.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(ProdavnicaZaKnigiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string firstName, string lastName)
        {
            ...
            {
                authorsQuery = authorsQuery.Where(a => a.FirstName.Contains(firstName));
            }

            if (!string.IsNullOrEmpty(lastName))
            {
                authorsQuery = authorsQuery.Where(a => a.LastName.Contains(lastName));
            }

            var viewModel = new AuthorFilterViewModel
            {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var author = await _context.Author
                .Include(a => a.Books).ThenInclude(b => b.BookGenres).ThenInclude(bg => bg.Genre)
